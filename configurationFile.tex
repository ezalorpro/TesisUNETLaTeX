...
\newcommand{\UnetFormat}{
	...
	\setcounter{LAnexos}{1} % contador en 1
	\def\thecontaAnexos{\Alph{LAnexos}}%

	\newcommand{\AgregarAnexo}[1]{%
		\clearpage%
		\newpage%
		\begin{center}%
		[Anexo~\thecontaAnexos]\par%
		[##1]%
		\stepcounter{LAnexos}
		\vspace{10pt}%
		\leavevmode
...
% Para modificar el Y en las referencias y bibliografia y agregar ., antes del Y
\DeclareDelimFormat*{finalnamedelim}
{\ifnum\value{liststop}>2 ,\fi\addspace y \space}
